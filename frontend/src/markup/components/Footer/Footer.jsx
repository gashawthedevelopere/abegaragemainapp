    ...
    <footer className="main-footer">
            ...
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">Ethiopia, Addis Ababa Town, <br /> Addis Ababa city, LemiKura,Wereda-03</div>
                </div>
              </div>
            </div>
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">Email us : <br /> <a
                    href="mailto:contact.contact@autorex.com">gashawsisay@gmail.com</a></div>
                </div>
              </div>
            </div>
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">Call us on : <br /><strong>+ 251-920-929-067</strong></div>
                </div>
              </div>
            </div>
      ...
      <div className="auto-container">
        <div className="footer-bottom">
          <div className="copyright-text">© Copyright <a href="#">GashawGarage</a> 2025 . All right reserved.</div>
        </div>
      </div>
    </footer>
  );
